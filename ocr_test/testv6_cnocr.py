...
class UniversalOCRLayout:
    def __init__(self, lang='ch'):
        self.ocr = CnOcr(rec_model_name='doc-densenet_lite_136-gru')
        self.font_path = '/Users/firshme/Desktop/work/WiseRead/Yuanti.ttc'  # 请替换为适合的字体文件路径
...
image_path = 'img_3.png'  # 替换为你的图像路径
output_path = 'ocr_result.html'  # 输出文件路径
